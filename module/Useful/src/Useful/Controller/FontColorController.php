...
class FontColorController {
	 ...
	 * 
	 * @param int $red
	 *        	number from 0-255 for blue color value
	 * @param int $green
	 *        	number from 0-255 for green color value
	 * @param int $blue
	 *        	number from 0-255 for blue color value
	 * @access public
	 */
	 ...
	 * Sets the HEX HTML color value like ffff00. It will convert shorthand to a 6 digit hex.
	 * 
	 * @param string $hex
	 *        	6,3,2, or 1 characters long.
	 * @access public
	 */
	 ...
	 * 
	 * @param int $c
	 *        	number from 0-100 for c color value
	 * @param int $m
	 *        	number from 0-100 for m color value
	 * @param int $y
	 *        	number from 0-100 for y color value
	 * @param int $b
	 *        	number from 0-100 for b color value
	 * @access public
	 */
	 ...
	 * Sets the pantone pc color value
	 * 
	 * @param string $pantone_name_pc
	 *        	name of the pantone pc color
	 * @access public
	 */
	 ...
	 * @access private
	 * @param string $name
	 *        	One of the offical HTML color names.
	 */
