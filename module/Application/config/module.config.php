...
return array(
    'router' => array(
        'routes' => array(
            ...
            'ef-company-profile' => array(
                'type' => 'Segment',
                'options' => array(
                    'route' => '/ef-company-profile[/][/:action]',
                    'constraints' => array(
                        'action' => '(?!\bpage\b)[a-zA-Z][a-zA-Z0-9_-]*'
                    ),
                    'defaults' => array(
                        'controller' => 'Application\Controller\CompanyProfile',
                        'action' => 'index'
                    )
                )
            ),
    ...
    'controllers' => array(
        'invokables' => array(
            ...
            // View Logged
            'Application\Controller\CompanyProfile' => 'Application\Controller\CompanyProfileController',
